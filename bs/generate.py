...
#python generate.py --model_path data/models/Agent_d.pt --out_file result/agent/agent_d/10k_samples.txt
#python generate.py --model_path data/models/Agent_dh.pt --out_file result/agent/agent_dh/10k_samples.txt
def main(args):
